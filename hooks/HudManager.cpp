                ...
                if ((IsInGame() || IsInLobby())) {
                        ...
                        if (!State.InMeeting && !State.DisableHud)
                        {
                                ...
                                if (ImpostorVentButton != NULL) {
                                        ...
                                        {
                                                app::GameObject_SetActive(ImpostorVentButton, (State.UnlockVents && !State.PanicMode) || (((*Game::pLocalPlayer)->fields.inVent && role != RoleTypes__Enum::Engineer)) || (PlayerIsImpostor(localData)), nullptr);
                                        }
                                }
