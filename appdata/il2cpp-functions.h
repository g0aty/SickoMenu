...
DO_APP_FUNC(void, PlayerControl_SetRole, (PlayerControl* __this, RoleTypes__Enum roleType, MethodInfo* method), "Assembly-CSharp, System.Void PlayerControl::SetRole(AmongUs.GameOptions.RoleTypes)");
