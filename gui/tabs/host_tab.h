...
namespace HostTab {
	const std::vector<const char*> MAP_NAMES = { "The Skeld", "Mira HQ", "Polus", /*"ehT dlekS", */"The Airship", "The Fungle"};
	...
	const std::vector<const char*> ROLE_NAMES = { "Random", "Crewmate", "Scientist", "Engineer", "Noisemaker", "Tracker", "Detective", "Impostor", "Shapeshifter", "Phantom", "Viper" };
	const RoleColor ROLE_NAMES_COLOR[] = {
		{"Random",			IM_COL32(  0, 255,   0, 255)},
		{"Crewmate",		IM_COL32(  0, 255, 255, 255)},
		{"Scientist",		IM_COL32(  0, 255, 255, 255)},
		{"Engineer",		IM_COL32(  0, 255, 255, 255)},
		{"Noisemaker",		IM_COL32(  0, 255, 255, 255)},
		{"Tracker",			IM_COL32(  0, 255, 255, 255)},
		{"Detective",		IM_COL32(  0, 255, 255, 255)},
		{"Impostor",		IM_COL32(255,  25,  25, 255)},
		{"Shapeshifter",	IM_COL32(255,  25,  25, 255)},
		{"Phantom",			IM_COL32(255,  25,  25, 255)},
		{"Viper",			IM_COL32(255,  25,  25, 255)},
	};
