    ...
    void Render() {
        ...
        if (openVisuals) {
            ...
            if (State.CustomName && ImGui::CollapsingHeader("Custom Name Options"))
            {
                ...
                ImGui::SameLine();
                if (CustomListBoxInt(" ", &fonts, FONTS, 160.f * State.dpiScale)) {
                    switch (fonts) {
                    case 0:
                        State.BarlowItalic = true;
                        State.BarlowMedium = false;
                        State.BarlowBold = false;
                        State.BarlowSemiBold = false;
                        State.BarlowSemiBoldM = false;
                        State.BarlowExtraBold = false;
                        State.BarlowBoldItalic = false;
                        State.BarlowBoldItalicM = false;
                        State.BarlowBlack = false;
                        State.BarlowLight = false;
                        State.BarlowRegular = false;
                        State.BarlowRegularM = false;
                        State.BarlowRegularO = false;
                        State.Brook = false;
                        State.LiberationSans = false;
                        State.NotoSans = false;
                        State.VCR = false;
                        State.CONSOLA = false;
                        State.Digital7 = false;
                        State.OCRAEXT = false;
                        State.DINProBold700 = false;
                        break;
                    case 1:
                        State.BarlowItalic = false;
                        State.BarlowMedium = true;
                        State.BarlowBold = false;
                        State.BarlowSemiBold = false;
                        State.BarlowSemiBoldM = false;
                        State.BarlowExtraBold = false;
